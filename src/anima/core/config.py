...
class EnvConfig:
    def __init__(self):
        ...
        self.db_url = get("db", "url", "OM_DB_URL", "sqlite:///anima.db")
        if self.db_url.startswith("sqlite:///"):
            self.db_path = self.db_url.replace("sqlite:///", "")
        else:
            default_db_path = str(Path(__file__).parent.parent.parent.parent / "datta" / "anima.sqlite")
